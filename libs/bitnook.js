...
export default class Bitnook {
	...
	createFile(form: string, name: string, desc: string): object { // TODO: rest of args
		const id = name.replace(' ','') // TODO: make unique
		console.log(`Create File: ${form}/${id}: ${name}: ${desc}`)
		// TODO: actually create
		return { form, file: id }
	}
	...
	updateFile(form: string, file: string, name: string, desc: string): object { // TODO: rest of args
		console.log(`Update File: ${form}/${file}: ${name}: ${desc}`)
		// TODO: actually update
		return { form, file }
	}
